...
let render;
let rendererMap = {};
const templatePath = resolve("../tpl.html"); //要么使用path.resolve以当前文件换算路径，要么写以最终执行脚本的位置的相对路径
...
if (isProd) {
    ...
    for (let pageName in appEntry) {
        ...
        promiseMap[pageName] = devServerSetup(
            ...
            tplPath,
            pageName,
            entry.clientConfig ? entry.clientConfig:null,
            entry.serverConfig ? entry.serverConfig:null,
